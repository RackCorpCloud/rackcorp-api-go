...
func (c *client) OrderConfirm(ctx context.Context, orderId string) (*ConfirmedOrder, error) {
	if orderId == "" {
...
func (c *client) OrderCreate(ctx context.Context, productCode string, customerId string, productDetails ProductDetails) (*CreatedOrder, error) {
	if productCode == "" {
...
func (c *client) OrderGet(ctx context.Context, orderId string) (*Order, error) {
	if orderId == "" {
		return nil, errors.New("orderId parameter is required")
	}
